...
<div class="max-w-3xl">
  <div class="bg-white rounded-2xl border border-zinc-200 shadow-sm p-6 md:p-8">
    <form action="{{ route('admin.promo-codes.store') }}" method="POST">
      ...
      <div class="space-y-6">
        <h2 class="text-lg font-bold text-neutral-900 mb-4 border-b border-zinc-100 pb-2">Detail Promo</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
           ...
           <div>
             ...
             <input type="text" id="code" name="code" value="{{ old('code') }}" required placeholder="Mis. HARBOLNAS24"
           ...
           <div>
             ...
             <input type="text" id="label" name="label" value="{{ old('label') }}" placeholder="Mis. Promo Akhir Tahun" 
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
           ...
           <div x-data="{ type: '{{ old('type', 'percentage') }}' }">
             ...
             <div class="mt-5">
               ...
               <div class="relative">
                  ...
                  <input type="number" id="value" name="value" value="{{ old('value') }}" required step="0.01" min="0" placeholder="0"
           ...
           <div>
              ...
              <div class="mb-5">
                ...
                <input type="number" id="min_purchase" name="min_purchase" value="{{ old('min_purchase') }}" min="0" placeholder="0"
                  class="w-full bg-neutral-50 rounded-xl py-3 px-4 text-sm font-medium focus:ring-2 focus:ring-indigo-500 border border-zinc-200">
              ...
              <div>
                ...
                <input type="number" id="max_discount" name="max_discount" value="{{ old('max_discount') }}" min="0" placeholder="0"
                  class="w-full bg-neutral-50 rounded-xl py-3 px-4 text-sm font-medium focus:ring-2 focus:ring-indigo-500 border border-zinc-200">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
           ...
           <div>
             ...
             <input type="number" id="usage_limit" name="usage_limit" value="{{ old('usage_limit') }}" min="1" placeholder="Mis. 100"
               class="w-full bg-neutral-50 rounded-xl py-3 px-4 text-sm font-medium focus:ring-2 focus:ring-indigo-500 border border-zinc-200">
             <p class="text-[10px] text-gray-500 mt-1.5">Jumlah maksimal kode ini bisa digunakan. Kosongkan jika tanpa batas.</p>
        ...
        <div class="mt-4 pt-4 border-t border-zinc-100">
          <label class="flex items-center gap-3 cursor-pointer p-4 rounded-xl border border-zinc-200 bg-neutral-50 w-full hover:border-indigo-500 transition max-w-sm">
            <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="w-5 h-5 text-indigo-600 border-zinc-300 rounded focus:ring-indigo-500">
            <div>
