        ...
        @forelse($testimonials as $testimonial)
          <tr class="hover:bg-neutral-50/50 transition">
            ...
            <td class="px-6 py-4 text-right whitespace-nowrap">
              ...
              <form action="{{ route('admin.testimonials.destroy', $testimonial->id) }}" method="POST" class="inline-block ml-1 delete-form" data-confirm="Apakah Anda yakin ingin menghapus testimoni ini?">
                @csrf
                @method('DELETE')
